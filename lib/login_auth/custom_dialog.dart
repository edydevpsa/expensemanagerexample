...
class CustomDialog extends StatelessWidget {
  final String title, description, primaryButtonText, optionalText, primaryButtonRoute, secondaryButtonText, secondaryButtonRoute;

  CustomDialog({ @required this.title, @required this.description, @required this.primaryButtonText, @required this.primaryButtonRoute, @required this.optionalText, this.secondaryButtonText, this.secondaryButtonRoute,});
            ...
            child: Column(
              ...
              children: [
                ...
                AutoSizeText(
                  optionalText, 
                  maxLines: 1, 
                  style: TextStyle(color: _primaryColor, fontSize:20.0),
                ),
                SizedBox(height: 24.0,),
